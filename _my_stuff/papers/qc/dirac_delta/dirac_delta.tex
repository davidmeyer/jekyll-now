...
&=&  \mathcal{L}\{g^\prime (t)\}                                 &\qquad \qquad \mathrel{\#} \text{set } g(t) = f'(t)                                                                                                         \\   
[8pt]
...
&=&  s^{2}F(s)- \sum\limits_{k=1}^2 s^{n-k} f^{(k-1)}(0)                                         &\qquad \qquad \mathrel{\#} \text{Equation \ref{eqn:nth-derivative} with $n = 2$}    \\
[10pt]
