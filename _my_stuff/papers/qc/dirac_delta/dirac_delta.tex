...
\bigskip
\noindent
The Linearity Property is saying that $\mathcal{L}$ is a linear operator or in other words: 
...
\begin{array}{lllll}
\mathcal{L}\{af(t) + bg(t)\} 
&=& \int_0^\infty e^{-st} \big [af (t) + bg(t) \big] dt                                & \mathrel{\#} \text{Definition \ref{def:laplace_transform} (Laplace Transform)}        \\  
[10pt]                                                                                                     % get a bit of space
&=& \int_0^\infty e^{-st} af (t)  dt + \int_0^\infty e^{-st}  bg(t)  dt          & \mathrel{\#} \text{by the linearity of improper integrals \cite{lewis2014}}                 \\
[10pt]                                                                                                     % get a bit of space
&=& a \int_0^\infty e^{-st}  f(t) dt + b \int_0^\infty e^{-st}  g(t) dt          & \mathrel{\#} \text{Definition \ref{def:constant_rule} (Constant Rule)}                \\
[10pt]                                                                                                     % get a bit of space
&=& a \mathcal{L}\{f(t)\}  + b \mathcal{L}\{g(t)\}                                   & \mathrel{\#} \text{Definition \ref{def:laplace_transform} (Laplace Transform)}
\end{array}
\end{equation*}
...
\begin{array}{lllll}
\mathcal{L}\{f(t)\}
&=& F(s)                                                                            &\quad  \mathrel{\#} \text{Definition \ref{def:laplace_transform} (Laplace Transform)}                                                                         \\  
[12pt]                                                                                 % get a bit of space
&=&   \mathlarger{\int}_0^\infty \! e^{-st} f(t) dt                  &\quad  \mathrel{\#} \text{Definition \ref{def:laplace_transform} (Laplace Transform)}                                                                         \\  
[12pt]                                                                                 % get a bit of space
&\leq& \mathlarger{\int}_0^\infty \! e^{-st}  Me^{ct}dt         &\quad  \mathrel{\#} \text{Definition \ref{def:exponential_order} ($f$ is of exponential order $c$)}                                                      \\  
[12pt]                                                                                 % get a bit of space               
...
[20pt]
&=& -\mathcal{L}\{tf(t)\}                                                                                    &\qquad \qquad \mathrel{\#} \text{Definition \ref{def:constant_rule} (Constant Rule with $a = -1$)}
\end{array}
\end{equation*}
