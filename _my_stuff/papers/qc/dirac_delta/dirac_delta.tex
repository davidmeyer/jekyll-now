...
\bigskip
\noindent
The first thing to observe is that $u(t-a)$ is zero for $t < a$ and one otherwise (Figure \ref{fig:u(t-a)}), so we can rewrite our integral with a lower limit of $a$.
