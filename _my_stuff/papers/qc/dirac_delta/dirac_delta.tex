...
approach its limit first. Said in another way:  $\lim\limits_{t \to \infty} \frac{f(t)}{e^{ct}} = 0$. This is shown in Figure \ref{fig:exponential_order}.
...
\begin{array}{lllll}
\mathcal{L}\{f(t)\}
&=& F(s)                                                                            &\quad  \mathrel{\#} \text{definition of the Laplace Transform}                                                                                                                           \\  
...
[10pt]                                                                                % get a bit of space
&=& \lim\limits_{d \to \infty}\Big [\frac{M}{c-s} e^{(c-s)d} \Big ] - \frac{M}{c - s}                 &\quad  \mathrel{\#} e^{(c-s)0} = 1                                                                                                                       \\
[10pt]                                                                                % get a bit of space
