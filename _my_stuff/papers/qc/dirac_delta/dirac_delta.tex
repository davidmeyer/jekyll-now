...
approach its limit first. That is, $\lim\limits_{t \to \infty} \frac{f(t)}{e^{ct}} = 0$. See Figure \ref{fig:exponential_order}.
...
[8pt]                                                                                   % get a bit of space
&\leq& \int_0^\infty e^{-st}  Me^{ct}dt                                &\quad  \mathrel{\#} \text{definition of exponential order with constants $M$ and $c$}                                                                                      \\  
[8pt]                                                                                   % get a bit of space               
&=& M  \int_0^\infty e^{-st} e^{ct} dt                                  &\quad  \mathrel{\#} \text{take $M$ outside the integral ($M$ doesn't depend on $t$)}                                                                                      \\   
[8pt]                                                                                   % get a bit of space
...
[8pt]                                                                                  % get a bit of space
&=&  \frac{M}{c-s} \int_0^\infty e^u du                              &\quad  \mathrel{\#} \text{neither $c$ nor $s$ depend on $t$}                                                                                                                             \\     
[8pt]                                                                                  % get a bit of space
&=&  M \frac{e^u}{c-s}   \Big |_0^\infty                              &\quad  \mathrel{\#} \int_0^\infty e^u du = e^u +C                                                                                                                                               \\     
[8pt]                                                                                  % get a bit of space
&=& M \frac{e^{(c-s)t}} {c-s} \Big |_0^\infty                       &\quad  \mathrel{\#}  u = (c-s)t                                                                                                                                                                              \\
[8pt]                                                                                  % get a bit of space     
&=& \lim\limits_{d \to \infty}\Big [M \frac{e^{(c-s)d}} {c-s} \Big ]- \frac{Me^{(c-s)0}} {c-s}   &\quad  \mathrel{\#} \text{evaluate at the limits}                                                                                                   \\
[8pt]                                                                                  % get a bit of space
&=& 0 - \frac{M} {\mathlarger{c-s}}                                   &\quad  \mathrel{\#} \text{we assumed that $s > c$ so $c -s < 0 \Rightarrow \lim\limits_{d \to \infty}\Big [M \frac{e^{(c-s)d}} {c-s} \Big ] = 0$}   \\    
[8pt]                                                                                  % get a bit of space
