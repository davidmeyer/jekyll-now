...
\bigskip
\begin{figure}[H]
\center{\includegraphics[scale=0.40,frame] {images/exponential_order.png}}
...
[20pt]
&=& -f(0) + s \mathcal{L}\{f(t)\}                                                                                                                                                          &\mathrel{\#} \text{Definition \ref{def:laplace_transform} (Laplace Transform)}                                          
\end{array}
\end{equation*}

\bigskip
\noindent
So $\mathcal{L}\{f^\prime(t)\} = -f(0) + s \mathcal{L}\{f(t)\}$. One of the interesting things to note here is that we've taken a statement about the derivative of $f$ and converted
it into a statement about $f$ itself, multiplied by $s$ and subtracting a constant ($f(0)$).
...
[20pt]
&=& -\mathcal{L}\{tf(t)\}                                                                                    &\qquad \qquad \mathrel{\#} \text{by the linearity of $\mathcal{L}\{f(t)\}$, with $a = -1$ (Section \ref{subsec:linearity})}
