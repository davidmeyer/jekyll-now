...
&=& \int_0^\infty e^{-st} af (t) + \int_0^\infty e^{-st}  bg(t)  dt               & \mathrel{\#} \text{by the linearity of improper integrals \cite{lewis2014}}                                     \\
[6pt]                                                                                                     % get a bit of space
&=& a \int_0^\infty e^{-st}  f(t) dt + b \int_0^\infty e^{-st}  g(t) dt          & \mathrel{\#} \text{constant multiple rule:} \int_a^b k f(x) dx = k \int _a^b f(x) dx                           \\
[6pt]                                                                                                     % get a bit of space
