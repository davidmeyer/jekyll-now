...
\begin{array}{lllll}
\mathcal{L}\{\delta_a(t)\} 
&=& \int_0^\infty e^{-st} \delta_a(t) dt     &\quad  \mathrel{\#} \text{Definition of the Laplace Transform, with $f(t) = \delta_a(t)$} \\  
[4pt]                                                        % get a bit of space
&=& \int_0^\infty e^{-st} g(t) dt               &\quad  \mathrel{\#} \text{Set $g(t) = e^{-st}$} \\
[4pt]                                                        % get a bit of space
&=& g(a)  &\quad  \mathrel{\#} \text{By Equation \ref{eqn:g(a)}} \\
[4pt]                                                        % get a bit of space
&=& e^{-sa}                                            &\quad  \mathrel{\#} \text{$g(a) = e^{-sa}$ since $g(t) = e^{-st}$}
\end{array}
\end{equation*}
