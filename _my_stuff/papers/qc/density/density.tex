...
\date{Last update: January 18, 2017}							% Activate to display a given date or no date
...
\bigskip
\noindent
Noting that $\braket{v_i | v_i} = 1$ (the $v_i$ are unit vectors) and $\braket{v_i | v_j} = 0$ ($v_i$ and $v_j$ are orthogonal).
