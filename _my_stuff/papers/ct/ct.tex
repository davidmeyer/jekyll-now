...
\begin{table}
  \begin{center}
    \begin{tabular}{r|c|c|c} 
      \textbf{RNA Load/ml} & \textbf{$\text{C}_t$ value} & \textbf{Infectious} & \textbf{Which Test Can Detect This Level Of RNA} \\
      \hline 
      100           & ?  & no  & RT-PCR                                                            \\
      1,000        & 36 & no  & RT-PCR                                                           \\
    ...
    \end{tabular}
  \end{center}
 \caption{RNA Load, $\text{C}_t$ values, and Infectiousness}
\end{table}
