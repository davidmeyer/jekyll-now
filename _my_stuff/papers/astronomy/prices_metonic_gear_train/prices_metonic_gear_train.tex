...
The Metonic cycle or enneadecaeteris (from Ancient Greek meaning "nineteen") is \emph{a period of approximately 19 years after which the 
...
\begin{figure}[H]
\center{\includegraphics[scale=0.65] {images/general_gearing_plan.png}}
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[scale=0.65] {images/sectional_diagram.png}}
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[scale=0.20,frame] {images/price_gear_train.png}}
