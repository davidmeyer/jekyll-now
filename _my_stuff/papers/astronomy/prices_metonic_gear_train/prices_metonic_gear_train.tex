...
\bigskip
\noindent
However, the Metonic cycle turns out to be very close to three other important lunar periods:

\begin{itemize}
\item 254 sidereal months (lunar orbits) = 6,939.702 days
\item 255 draconic months (lunar nodes) = 6,939.1161 days
\item 239 anomalistic months (perigee to perigee) = 6,585.5375 days
\end{itemize}
...
\item $\approx$ 239 anomalistic months 
\end{itemize}
