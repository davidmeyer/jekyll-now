...
is correct \cite{Freeth2006}.} I decided to look at the Metonic gear train first since it is a simple gear train; specifically this gear train has no epicyclic gears \cite{Wright2005} 
...
\bigskip
\noindent
The Metonic Cycle also turns out to be very close to two other important lunar periods:
...
\begin{itemize}
\item One Metonic Cycle = 19 years 
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[scale=0.20,cfbox=red] {images/metonic.png}}
