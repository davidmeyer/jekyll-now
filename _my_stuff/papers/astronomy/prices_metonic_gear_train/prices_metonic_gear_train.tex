...
\section{Michael Wright's Metonic Cycle Gearing Scheme}
Michael Wright suggested a different scheme for turning the Metonic pointer \cite{Wright2005a}. Wright noticed that 
$235 \text{ synodic (lunar) months} =  5 \times 47 \text{ lunar months}$ and proposed that the Metonic 
dial was a five turn spiral dial. He proposed the following gearing scheme to move the Metonic pointer 
on a five turn dial:
...
\bigskip
\noindent
So one turn of the main drive gear (B1) moves Wright's Metonic pointer by $\frac{5}{19} \approx 0.2632$, and nineteen turns of B1 (one Metonic Cycle) results in five
turns of Wright's Metonic pointer, consistent with Wright's five turn spiral Metonic dial model.


\bigskip
\noindent
BTW, note that I2 and N1 cancel in this gear train, so why are they there? The answer is to drive the Saros eclipse prediction dial, a
