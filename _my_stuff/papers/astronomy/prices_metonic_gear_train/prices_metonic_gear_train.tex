...
just as required. However, Price (incorrectly) thought that the output of his Metonic Cycle gear train went directly to the front Zodiac dial that 
Albert Rehm \cite{wiki:rehm} had proposed to show the average position of the Moon in the Zodiac.
...
and proposed that the Metonic dial was a five turn spiral dial where each revolution represented 47 lunar months (Price's Metonic dial was a 4 turn dial). He 
proposed the following gearing scheme to move the Metonic pointer on this five turn dial:
