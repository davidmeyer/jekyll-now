...
dial was a five turn spiral dial where each turn represented 47 lunar months (Price's Metonic Dial was a 4 turn dial).
He proposed the following gearing scheme to move the Metonic pointer on this five turn dial:
...
relative geometry (close to a straight line) and a nearly identical eclipse will occur in what is referred to as an eclipse cycle \cite{wiki:saros}.
