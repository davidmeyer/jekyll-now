...
is generally considered to be correct by researchers \cite{Freeth2006}.} I decided to look at the Metonic gear train first since it is a simple gear train; 
