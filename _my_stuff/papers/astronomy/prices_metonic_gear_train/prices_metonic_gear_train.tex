...
\bigskip
\noindent
Unfortunately Price was wrong. He incorrectly thought that the output of his Metonic Cycle gear train, at the 32 tooth gear e2, went directly to the Zodiac dial 
on the front of the Mechanism (this is the dial that Albert Rehm \cite{wiki:rehm} had proposed to show the average position of the Moon in the Zodiac). 
What this gear train actually does is to calculate the number of sidereal months in a year. This output is then used to drive the 50 tooth gear e5 which is 
part of the four gear pin-and-slot device.
